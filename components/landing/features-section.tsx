...
const features = [
  {
    ...
    description:
      "Blisswork, GRC, and WCAG are each built for a specific job, not bolted onto a generic platform. That focus shows up in how they feel to use.",
    visual: "deploy",
  },
  {
    number: "02",
    ...
    description:
      "From data handling to accessibility, our products are engineered against real standards — WCAG 2.2, ISO 27001 principles, and India's DPDP Act.",
    visual: "security",
  },
  {
    number: "03",
    ...
    description:
      "HR, compliance, and engineering teams shape how our products work. Every workflow is designed to fit into how people already operate.",
    visual: "collab",
  },
  {
    number: "04",
    title: "A single, growing portfolio",
    description:
      "As AEIV Global grows, our products grow together — sharing design language, security posture, and a commitment to getting the details right.",
    visual: "ai",
  },
];
...
export function FeaturesSection() {
  ...
  return (
    <section id="why-us" ref={sectionRef} className="relative py-24 lg:py-32">
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        <div className="mb-16 lg:mb-24">
          ...
          >
            Software built with
            <br />
            <span className="text-muted-foreground">care, not shortcuts.</span>
          </h2>
        </div>
